...
# 封装的字段类型
# StringField \ IntegerField \ FloatField \ BoolField \ TextField \ BlobField \ VersionField
class Field(object):
    """
    保存数据库中的表的  字段属性
...
class ModelMetaclass(type):
    ...
    属性和字断的mapping:
        ...
        3.新增“__mappings__”属性， 保存提取出来的mapping 数据
    类和表的mapping:
        1.提取类名，保存为表名
    ...
    def __new__(cls, name, bases, attrs):
        ...
        # store all subclasses info: ——> 存储所有子类信息
        ...
        # print 'primary_key is %s' % primary_key
...
class Model(dict):
    ...
    def update(self, E=None, **F):
        """
        如果改行的字段属性有 updatable, 代表该字段可以被更新
...
if __name__ == '__main__':
    ...
    db.create_engine('jn', '654321', 'openlaw', '192.168.21.134')
